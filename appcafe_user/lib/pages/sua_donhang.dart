...
class _SuaDonHangState extends State<SuaDonHang> {
  ...
  void initState() {
    ...
    soLuongCtrl = TextEditingController(
      text: widget.donHang.soLuong.toString(),
    );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Chi tiết & Sửa đơn hàng"),
      ),
              ...
              child: Column(
                children: [
                  _buildDetailRow(
                    ...
                    "Bàn:",
                    widget.donHang.tenBan,
                  ),
                  const Divider(),
                  _buildDetailRow(
                    Icons.delivery_dining,
                    "Hình thức:",
                    widget.donHang.hinhThuc,
                  ),
                  const Divider(),
                  _buildDetailRow(
                    Icons.local_cafe,
