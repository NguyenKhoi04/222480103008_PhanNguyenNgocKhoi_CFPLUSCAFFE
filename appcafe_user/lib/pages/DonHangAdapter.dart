...
class DonHangWidget extends StatefulWidget {
  ...
  @override
  State<DonHangWidget> createState() =>
      _DonHangWidgetState();
}

class _DonHangWidgetState
    extends State<DonHangWidget> {
  final supabase =
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  "Size: ${donHang.size} | Đá: ${donHang.mucDa}",
                ),
  ...
  void _confirmDelete(
    ...
    showDialog(
      ...
      builder:
        ...
        content: Text(
          "Bạn có chắc muốn xóa '${donHang.tenSanPham}' không?",
        ),
        actions: [
          TextButton(
            onPressed:
