  ...
  Future<void> _submitDanhGia() async {
    ...
    try {
      await supabase.from('reviews').insert({
        'image_url':
            _hinhAnhController.text.trim().isEmpty
                ? null
        ...
        'customer_comment':
            _khachPhanHoiController.text.trim(),
